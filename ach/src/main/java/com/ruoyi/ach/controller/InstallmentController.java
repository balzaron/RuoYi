...
public class InstallmentController extends BaseController {
    private String prefix = "system/installment" ;

    @Autowired
    private IInstallmentService installmentService;

    @RequiresPermissions("system:installment:view")
    @GetMapping()
     ...
     * 查询分期列表
     */
    @RequiresPermissions("system:installment:list")
    @PostMapping("/list")
    @ResponseBody
     ...
     * 导出分期列表
     */
    @RequiresPermissions("system:installment:export")
    @PostMapping("/export")
    @ResponseBody
     ...
     * 新增保存分期
     */
    @RequiresPermissions("system:installment:add")
     ...
     * 修改保存分期
     */
    @RequiresPermissions("system:installment:edit")
     ...
     * 删除分期
     */
    @RequiresPermissions("system:installment:remove")
